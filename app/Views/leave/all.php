...
<div class="page-title-bar">
    ...
    <div style="flex: 1;">
        ...
        <p class="text-muted">Full history across every employee.</p>
    </div>
    <a href="<?= site_url('leave/pending') ?>" class="btn-secondary">View Pending Only</a>
</div>
...
<table class="data-table">
    <thead>
        <tr><th>Employee</th><th>Type</th><th>From</th><th>To</th><th>Days</th><th>Status</th><th>Reviewed</th></tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><?= $req['reviewed_at'] ? esc(date('d M Y', strtotime($req['reviewed_at']))) : '-' ?></td>
        </tr>
        <?php endforeach; ?>
